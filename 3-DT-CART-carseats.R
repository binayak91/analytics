...
#Model
tree1 = rpart(Sales ~ . , data=data, method='anova' ) #anova to create a regression tree
tree1
...
prunetree = prune(tree1, cp=0.016043)
#here we have selected a different value to simplify the tree

prunetree
rpart.plot(prunetree, nn=T, cex=.8)
#Interpretation
