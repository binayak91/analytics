...
printcp(fit) #select complexity parameter (when to stop a tree) xerror- cross validation error, lower the error better the decision tree
...
#example of classification (yes or no)